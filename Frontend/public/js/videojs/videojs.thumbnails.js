function thumb(player) {
    ...
    var div, settings, img, progressControl, duration, moveListener, moveCancel, thumbTrack;
    ...
    progressControl = player.controlBar.progressControl.eventBusEl_.firstChild;
    progressControl.appendChild(div);
    ...
    moveListener = function (event) {
        ...
        clientRect = offsetParent(progressControl).getBoundingClientRect();
        ...
        left -= offsetParent(progressControl).getBoundingClientRect().left + pageXOffset;
        ...
        mouseTime = Math.floor((left - progressControl.offsetLeft) / player.controlBar.progressControl.width() * duration);
    ...
    progressControl.addEventListener('mousemove', moveListener);
    progressControl.addEventListener('touchmove', moveListener);
    ...
    progressControl.addEventListener('mouseout', moveCancel);
    progressControl.addEventListener('touchcancel', moveCancel);
    progressControl.addEventListener('touchend', moveCancel);
