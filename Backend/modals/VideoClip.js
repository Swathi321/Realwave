...
const videoClipSchema = new Schema({
    ...
    ViewedOn: { type: Date, default: null },
    primaryStreamId: { type: String },
    AlarmEvent: {type: String, default: null},
    EventDetail : {type : String, default: null}
}, { timestamps: true });

videoClipSchema.index({ EventTime: 1, Category: 1, EventType: 1, Status: 1, Total: 1, StoreId: 1, InvoiceId: 1, IsVideoAvailable: 1 });

module.exports = mongoose.model('videoClip', videoClipSchema, 'videoClip');