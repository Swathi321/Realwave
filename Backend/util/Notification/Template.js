class Template {
    static get Email() {
        return {
            ...
            ScaleEmail: {
                Subject: 'Realwave Notifications',
                Body: `This notification is being sent from your site configuration below<br/>
                <b>Rule:</b> Baggage over {Weight} pounds <br/>
                <b>Trigger:</b> {Trigger} pounds <br/>
                <b>Trigger ID:</b> {ScaleId}<br/>
                <b>Date/Time::</b> {DateTime}<br/><br/>`
            },
            AccessReport: {
                Subject: 'Realwave Notifications',
                Body: `This notification is being sent from your site configuration below<br/>
                The {PublisherId} was {Type} at {DateTime} for Site {Site}<br/>
              `
            }
        }
    }
    ...
    static get Text() {
        return {
            //TODO: Need to add template according to requirement
        }
    }
}
